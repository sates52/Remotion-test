# YouTube pack — Show Your Work!: 10 Ways to Share Your Creativity and Get Discovered (Austin Kleon)

> Engine: antidote · 36 min · Title limit **100 chars** (front-load the hook in the first ~45). Description first ~157 chars show above the fold. Tags cap 500 chars. First 3 hashtags render above the title.
> ✓ Claude-refined (claude-refined)

## TITLE — paste one (recommended first)

```
Show Your Work! by Austin Kleon — Summary & Key Ideas
```
Alternatives (A/B):
- Show Your Work! Summary: Why Obscurity Is the Real Creative Trap (Austin Kleon)
- Austin Kleon's Show Your Work! Explained: Process Over Product
- How to Share Your Creativity and Get Discovered — Show Your Work! Book Summary
- Show Your Work! (Austin Kleon): Stop Hiding Your Work — 10 Lessons Explained

**Primary keyword:** Show Your Work Austin Kleon summary
...
- [ ] Tags: paste block
- [ ] Thumbnail: `out/thumbnail-show-your-work.png`
- [ ] Captions: upload `public/captions/show-your-work.clean.vtt` as English CC → **"With timing"** (NOT the raw show-your-work.vtt)
