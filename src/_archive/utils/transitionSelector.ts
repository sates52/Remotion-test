...
const CREATIVE_TRANSITIONS: TransitionType[] = ['rotate', 'circleWipe', 'pixelate', 'colorShift', 'slide', 'wipe', 'ripple', 'prismShift', 'verticalBlinds', 'diamondWipe', 'swooshWipe', 'shadowReveal'];
...
const FAST_ANIMATIONS: AnimationType[] = ['zoom', 'whipPan', 'rotate', 'arcaneSwirl'];
