...
const CAPTION_PRESETS: CaptionStylePreset[] = [
    ...
    'vintage', 'modern', 'bold', 'minimal', 'dramatic', 'elegant', 'tiktok', 'noir_mystery',
];
    ...
    switch (preset) {
        ...
        case 'noir_mystery':
            return {
                ...
                textColor: '#e5e7eb',
                highlightColor: '#f2a900', // Warning/Amber stark highlight
                fontFamily: "'Courier New', Courier, 'Inter', monospace",
                fontWeight: 600,
                fontSize: baseFontSize + 6,
                padding: '16px 36px',
                borderRadius: 4,
                textShadow: '0 4px 6px rgba(0,0,0,0.9), 0 0 15px rgba(242,169,0,0.4)',
                boxShadow: '0 8px 32px rgba(0,0,0,0.6), inset 0 0 10px rgba(255,255,255,0.05)',
