...
export interface Segment {
    ...
    bookNumber?: number;
    /** Optional visual effect for this segment */
    effect?: ShortsEffectConfig;
}
...
/** Effect types for visual flair */
export type ShortsEffectType = 'starburst' | 'shape' | 'glow' | 'glass' | 'none';

/** Effect configuration */
export interface ShortsEffectConfig {
    type: ShortsEffectType;
    seed?: string;
    color?: string;
}
