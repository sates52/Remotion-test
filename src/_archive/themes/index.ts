...
export const themes: Record<string, Theme> = {
  ...
  gilded: {
    name: 'Gilded & Vengeance',
    background: {
      gradient: ['#0f0c08', '#2d2419'],
...
export const getTheme = (genre: string): Theme => {
  ...
  const themeKey = genreMap[normalizedGenre] || (normalizedGenre.includes('gilded') ? 'gilded' : 'mystery');
  return themes[themeKey] || themes.gilded;
};
